...
class DriverEditScreen extends Screen {
    public $name = 'Izmeni informacije o vozacu';

    public $description = 'Svi detalji o vozacu, ime, prezime, telefon ...';
    ...
    public function layout(): array
    {
        return [
            ...
            Layout::block(UserEditLayout::class)
                ...
                ->description(__('Opste informacije o vozacu, ove informacije vozac ne moze da menja samostalno'))
                ->commands(
                    Button::make(__('Sacuvaj'))
                        ->type(Color::DEFAULT())
                        ->icon('check')
